...
function LineGraph(props) {
  ...
  useEffect(() => {
    if (!(props.data.length < 1)) {
      setData(
        {
          //for printing dates below linechart fetched from api
          labels: [
          ...
          datasets: [
            ...
            },
            {
              ...
              //the fetched data for last 7 days' daily deceased
              data: [
            ...
            },
            {
              ...
              //the fetched data for last 7 days' daily recovered
              data: [
